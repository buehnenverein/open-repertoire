...
{
	if (region.U.G === region.am.G)
	{
		return 'on line ' + region.U.G;
	}
	return 'on lines ' + region.U.G + ' through ' + region.am.G;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bE, request.C, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {at: fragment, aA: host, bI: path, aS: port_, aY: protocol, aZ: query};
	});
...
var $author$project$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{F: inputs, j: $author$project$Main$Init},
...
var $author$project$Main$subscriptions = function (model) {
	...
	if ((_v0.$ === 1) && (!_v0.a.$)) {
		...
		return $author$project$Main$receiveResult(
			$author$project$Main$ReceiveValidationResult(responseValue));
	} else {
		return $elm$core$Platform$Sub$none;
	}
};
var $author$project$Main$JsonParsingError = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$RequestFailed = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$Response = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$ResultError = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Main$ResultSuccess = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Main$Validating = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$ValidationParsingError = function (a) {
	return {$: 6, a: a};
};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bq: false, bs: r.bs, bx: r.bx, ax: r.ax, bE: r.bE, bP: r.bP, bf: r.bf, C: r.C}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bs: $elm$http$Http$emptyBody, bx: r.bx, ax: _List_Nil, bE: 'GET', bP: $elm$core$Maybe$Nothing, bf: $elm$core$Maybe$Nothing, C: r.C});
};
...
var $author$project$Main$getKeyword = function (issue) {
	return A3(
...
var $author$project$Main$isInteger = function (string) {
...
var $author$project$Main$isEquivalentPathComponent = F2(
	function (a, b) {
		return _Utils_eq(a, b) || ($author$project$Main$isInteger(a) && $author$project$Main$isInteger(b));
	});
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$isEquivalentPath = F2(
	function (list1, list2) {
		return (!_Utils_eq(
			...
			$elm$core$List$all,
			$elm$core$Basics$identity,
			A3($elm$core$List$map2, $author$project$Main$isEquivalentPathComponent, list1, list2));
	});
var $author$project$Main$similarPath = F2(
	function (path1, path2) {
		return A2(
			$author$project$Main$isEquivalentPath,
...
var $author$project$Main$similarIssues = F2(
	function (issue1, issue2) {
		return A2($author$project$Main$similarPath, issue1.bI, issue2.bI) && (_Utils_eq(issue1.bD, issue2.bD) && _Utils_eq(
...
var $author$project$Main$ValidationIssue = F3(
	function (path, message, kind) {
		return {aG: kind, bD: message, bI: path};
	});
...
var $author$project$Helper$CustomValidations$geocoordinates = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.aH, data.aJ);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 1) {
				if (!_v0.b.$) {
...
var $author$project$Helper$CustomValidations$teaserOrDescription = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.bd, data.ak);
		if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
			var _v1 = _v0.a;
			var _v2 = _v0.b;
			return _List_fromArray(
...
var $author$project$Data$Root$Root = F4(
	function (address, name, productions, version) {
		return {ad: address, s: name, aX: productions, bh: version};
	});
var $author$project$Data$Root$Address = F3(
	function (city, postalCode, streetAddress) {
		return {L: city, N: postalCode, O: streetAddress};
	});
...
var $author$project$Data$Root$Production = F9(
	function (accessibility, additionalInfo, description, events, genre, participants, subtitle, teaser, title) {
		return {Y: accessibility, ab: additionalInfo, ak: description, aq: events, av: genre, aQ: participants, bb: subtitle, bd: teaser, be: title};
	});
var $author$project$Data$Root$Accessibility = F3(
	function (accessModeSufficient, accessibilityHazard, accessibilitySummary) {
		return {X: accessModeSufficient, Z: accessibilityHazard, _: accessibilitySummary};
	});
...
var $author$project$Data$Root$Event = F6(
	function (duration, endDate, locations, offers, startDate, url) {
		return {al: duration, an: endDate, aI: locations, aP: offers, a9: startDate, C: url};
	});
...
var $author$project$Data$Root$AddressLocation = F8(
	function (city, latitude, longitude, name, postalCode, streetAddress, locationType, wheelChairPlaces) {
		return {L: city, aH: latitude, M: locationType, aJ: longitude, s: name, N: postalCode, O: streetAddress, bk: wheelChairPlaces};
	});
...
var $author$project$Data$Root$addressLocationDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Data$Root$Physical,
	A4(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
		'wheelChairPlaces',
...
var $author$project$Data$Root$locationDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[$author$project$Data$Root$addressLocationDecoder, $author$project$Data$Root$virtualLocationDecoder]));
...
var $author$project$Data$Root$Offer = F5(
	function (maxPrice, minPrice, name, priceCurrency, url) {
		return {aK: maxPrice, aL: minPrice, s: name, aT: priceCurrency, C: url};
	});
...
var $author$project$Data$Root$Participant = F3(
	function (_function, names, roleName) {
		return {au: _function, aN: names, a3: roleName};
	});
...
var $author$project$Main$groupedWarnings = function (jsonValue) {
	return $author$project$Main$groupIssues(
		$author$project$Main$parseWarnings(jsonValue));
};
var $author$project$Main$jsonDecoder = $elm$json$Json$Decode$value;
...
var $author$project$Main$ErrorInfo = F3(
	function (keyword, additionalProperty, allowedEnumValues) {
		return {ac: additionalProperty, ae: allowedEnumValues, aF: keyword};
	});
...
var $author$project$Main$issueTypeDecoder = A2(
	...
	function (info) {
		return $elm$json$Json$Decode$succeed(
			$author$project$Main$ValidationError(info));
	},
	A4(
		$elm$json$Json$Decode$map3,
		$author$project$Main$ErrorInfo,
...
var $author$project$Main$issueDecoder = $elm$json$Json$Decode$list(
	A4(
		$elm$json$Json$Decode$map3,
		$author$project$Main$ValidationIssue,
		A2($elm$json$Json$Decode$field, 'instancePath', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'message', $elm$json$Json$Decode$string),
		$author$project$Main$issueTypeDecoder));
var $author$project$Main$resultDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (isValid) {
		return isValid ? $elm$json$Json$Decode$succeed($author$project$Main$Valid) : A2(
			$elm$json$Json$Decode$map,
			$author$project$Main$Error,
			A2($elm$json$Json$Decode$field, 'errors', $author$project$Main$issueDecoder));
	},
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var inputs = $author$project$Main$getInputs(model);
		switch (msg.$) {
			case 0:
				var url = msg.a;
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							bx: A2($elm$http$Http$expectJson, $author$project$Main$Response, $author$project$Main$jsonDecoder),
							C: url
						}));
			case 1:
				var text = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$jsonDecoder, text);
				if (!_v1.$) {
					var jsonValue = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
			...
			default:
				...
				var _v2 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$resultDecoder, validationResult);
				if (!_v2.$) {
					if (!_v2.a.$) {
						var _v3 = _v2.a;
						return _Utils_Tuple2(
								...
								model,
								{
									j: A2(
										$author$project$Main$ResultError,
										{
											...
											bj: $author$project$Main$groupedWarnings(responseValue)
										},
										responseValue)
								}),
							$elm$core$Platform$Cmd$none);
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Main$SubmitUrl(inputs.C)),
...
var $author$project$Main$viewRequestError = function (error) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$viewValid = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Main$getAdditionalProperty = function (issue) {
	return A3(
		$author$project$Main$getErrorInfoField,
		function ($) {
			return $.ac;
...
var $author$project$Main$getAllowedEnumValues = function (issue) {
	return A3(
		$author$project$Main$getErrorInfoField,
		function ($) {
			return $.ae;
...
var $author$project$Main$decodePath = function (components) {
	return A3(
		$elm$core$List$foldr,
		F2(
...
var $author$project$Main$extractPath = F2(
	function (path, jsonValue) {
		...
		if ($elm$core$String$isEmpty(path)) {
			...
			var _v0 = A2(
				$elm$json$Json$Decode$decodeValue,
				$author$project$Main$decodePath(components),
				jsonValue);
			if (!_v0.$) {
				var value = _v0.a;
...
var $author$project$Main$viewHighlightedJson = F2(
	function (_v0, jsonValue) {
		...
		var extractAdditionalProperties = function (errors) {
			return A2($elm$core$List$filterMap, $author$project$Main$getAdditionalProperty, errors);
		};
		var highlightAdditionalProperties = function (line) {
			return ($author$project$Main$getKeyword(err) === 'additionalProperties') ? A2(
				$elm$core$List$any,
				isProperty(line),
		...
		return A2(
			...
			A2(
				...
				'\n',
				A2($author$project$Main$extractPath, err.bI, jsonValue)));
	});
var $author$project$Main$viewValidationIssue = F2(
	function (jsonValue, _v0) {
		var err = _v0.a;
		var others = _v0.b;
		var errorPath = $elm$core$String$isEmpty(err.bI) ? 'Top-level object' : err.bI;
		var additionalProperties = $elm_community$list_extra$List$Extra$unique(
			A2(
				$elm$core$List$filterMap,
				$author$project$Main$getAdditionalProperty,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$author$project$Main$viewHighlightedJson,
...
var $author$project$Main$viewValidationErrors = F2(
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(
										$elm$core$List$map,
										$author$project$Main$viewValidationIssue(jsonValue),
										errors))
								]))
						]))
				]));
...
var $author$project$Main$viewValidationWarnings = F2(
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewIntroduction,
				A2(
				$author$project$Main$viewInputs,
				...
				switch (_v0.$) {
					...
					case 2:
						var error = _v0.a;
						return $author$project$Main$viewRequestError(error);
					case 3:
						var warnings = _v0.a;
						var jsonValue = _v0.b;
						return A2(
					...
					case 4:
						...
						return A2(
							...
							_List_fromArray(
								[
									A2($author$project$Main$viewValidationErrors, errors, jsonValue),
									A2($author$project$Main$viewValidationWarnings, warnings, jsonValue)
								]));
					case 5:
						var message = _v0.a;
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{bB: $author$project$Main$init, bO: $author$project$Main$subscriptions, bQ: $author$project$Main$update, bR: $author$project$Main$view});
