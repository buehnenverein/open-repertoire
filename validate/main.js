...
{
	if (region.ah.I === region.aD.I)
	{
		return 'on line ' + region.ah.I;
	}
	return 'on lines ' + region.ah.I + ' through ' + region.aD.I;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.b0, request.E, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aL: fragment, aR: host, b4: path, a9: port_, bi: protocol, bj: query};
	});
...
var $author$project$Validate$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{H: inputs, l: $author$project$Validate$Init},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bN: false, bP: r.bP, bU: r.bU, aO: r.aO, b0: r.b0, cc: r.cc, bB: r.bB, E: r.E}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{bP: $elm$http$Http$emptyBody, bU: r.bU, aO: _List_Nil, b0: 'GET', cc: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, E: r.E});
};
...
var $author$project$Validate$similarIssues = F2(
	function (issue1, issue2) {
		return A2($author$project$Validate$similarPath, issue1.b4, issue2.b4) && (_Utils_eq(issue1.b$, issue2.b$) && _Utils_eq(
...
var $author$project$Validate$ValidationIssue = F3(
	function (path, message, kind) {
		return {aY: kind, b$: message, b4: path};
	});
...
var $author$project$Helper$CustomValidations$creatorItem = $author$project$Helper$CustomValidations$object(
	_List_fromArray(
		[
			A3(
			$author$project$Helper$CustomValidations$field,
...
var $author$project$Helper$CustomValidations$geocoordinates = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.aZ, data.a$);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 1) {
				if (!_v0.b.$) {
					...
					return _List_fromArray(
						[
							A2($author$project$Helper$CustomValidations$ValidationMessage, path, 'has a longitude but no latitude')
						]);
				} else {
					break _v0$2;
				}
				...
				if (_v0.b.$ === 1) {
					...
					return _List_fromArray(
						[
							A2($author$project$Helper$CustomValidations$ValidationMessage, path, 'has a latitude but no longitude')
						]);
				} else {
					break _v0$2;
				}
...
var $author$project$Helper$CustomValidations$addressLocation = $author$project$Helper$CustomValidations$object(
	_List_fromArray(
		[
			A3(
			$author$project$Helper$CustomValidations$field,
...
var $author$project$Helper$CustomValidations$location = F2(
	function (path, data) {
		if (!data.$) {
			var physical = data.a;
			return A2($author$project$Helper$CustomValidations$addressLocation, path, physical);
		} else {
			var virtual = data.a;
...
var $author$project$Helper$CustomValidations$previousStartDateIsSet = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple3(data.aH, data.bw, data.bb);
		_v0$3:
		while (true) {
			if (!_v0.a.$) {
				if (!_v0.c.$) {
...
var $author$project$Helper$CustomValidations$event = $author$project$Helper$CustomValidations$object(
	_List_fromArray(
		[
			...
			$author$project$Helper$CustomValidations$optional),
			$author$project$Helper$CustomValidations$previousStartDateIsSet
		]));
var $author$project$Helper$CustomValidations$teaserOrDescription = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.ak, data.aB);
		if ((_v0.a.$ === 1) && (_v0.b.$ === 1)) {
			var _v1 = _v0.a;
			var _v2 = _v0.b;
			return _List_fromArray(
				[
					A2($author$project$Helper$CustomValidations$ValidationMessage, path, 'has neither a description nor a teaser. You should set at least one of these fields.')
				]);
		} else {
			return _List_Nil;
		}
...
var $author$project$Helper$CustomValidations$production = $author$project$Helper$CustomValidations$object(
	_List_fromArray(
		[
			...
			$author$project$Helper$CustomValidations$maybe(
				$author$project$Helper$CustomValidations$list($author$project$Helper$CustomValidations$creatorItem))),
			A3(
			$author$project$Helper$CustomValidations$field,
			'/description',
			function ($) {
...
var $author$project$Data$Root$Root = F4(
	function (atContext, organization, productions, version) {
		return {at: atContext, a7: organization, bh: productions, bD: version};
	});
...
var $author$project$Data$Root$Organization = F3(
	function (atType, address, name) {
		return {N: address, e: atType, j: name};
	});
var $author$project$Data$Root$Address = F4(
	function (atType, addressLocality, postalCode, streetAddress) {
		return {ar: addressLocality, e: atType, ba: postalCode, bx: streetAddress};
	});
									...
									return function (genre) {
										return function (name) {
											return function (subtitle) {
												return {ak: _abstract, al: accessModeSufficient, am: accessibilityHazard, an: accessibilitySummary, ap: additionalInfo, e: atType, O: creator, aB: description, aI: events, aM: genre, j: name, bz: subtitle};
											};
										};
									};
								};
...
var $author$project$Data$Root$CreatorItem = F3(
	function (atType, creator, roleName) {
		return {e: atType, O: creator, bp: roleName};
	});
						...
						return function (performer) {
							return function (previousStartDate) {
								return function (startDate) {
									return function (url) {
										return {e: atType, aC: duration, aE: endDate, aH: eventStatus, a_: location, a6: offers, P: performer, bb: previousStartDate, bw: startDate, E: url};
									};
								};
							};
						};
...
var $author$project$Data$Root$AddressLocation = F6(
	function (atType, address, latitude, longitude, name, wheelChairPlaces) {
		return {N: address, e: atType, aZ: latitude, a$: longitude, j: name, bG: wheelChairPlaces};
	});
...
var $author$project$Data$Root$WheelChairPlaces = F3(
	function (count, hasSpaceForAssistant, wheelchairUserCapacity) {
		return {ay: count, aN: hasSpaceForAssistant, bH: wheelchairUserCapacity};
	});
...
var $author$project$Data$Root$Offer = F4(
	function (atType, name, priceSpecification, url) {
		return {e: atType, j: name, bd: priceSpecification, E: url};
	});
...
var $author$project$Data$Root$PriceSpecification = F4(
	function (atType, maxPrice, minPrice, priceCurrency) {
		return {e: atType, a0: maxPrice, a1: minPrice, bc: priceCurrency};
	});
...
var $author$project$Data$Root$PerformerItem = F3(
	function (atType, characterName, performer) {
		return {e: atType, aw: characterName, P: performer};
	});
...
var $author$project$Validate$ErrorInfo = F3(
	function (keyword, additionalProperty, allowedEnumValues) {
		return {aq: additionalProperty, as: allowedEnumValues, aX: keyword};
	});
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							bU: A2($elm$http$Http$expectJson, $author$project$Validate$Response, $author$project$Validate$jsonDecoder),
							E: url
						}));
			case 1:
				var text = msg.a;
							...
							_Utils_update(
								model,
								{
									l: A2(
										...
										{
											aF: $author$project$Validate$groupIssues(errors),
											bF: $author$project$Validate$groupedWarnings(responseValue)
										},
										responseValue)
								}),
							$elm$core$Platform$Cmd$none);
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(inputs.E),
					...
					_List_fromArray(
						[
							...
							$author$project$Validate$SubmitUrl(inputs.E)),
							$elm$html$Html$Attributes$disabled(
							(!buttonEnabled) || $elm$core$String$isEmpty(inputs.E)),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(inputs.C),
							$elm$html$Html$Attributes$class('u-full-width')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Validate$SubmitJson(inputs.C)),
							$elm$html$Html$Attributes$disabled(
							(!buttonEnabled) || $elm$core$String$isEmpty(inputs.C)),
							$elm$html$Html$Attributes$class('button-primary u-pull-right')
						]),
					_List_fromArray(
						[
	...
	function (_v0, jsonValue) {
		...
		var isProperty = F2(
			function (line, property) {
				return A2($elm$core$String$contains, '\"' + (property + '\":'), line);
			});
		...
		return A2(
			...
			A2(
				...
				'\n',
				A2($author$project$Validate$extractPath, err.b4, jsonValue)));
	});
var $author$project$Validate$viewValidationIssue = F2(
	function (jsonValue, _v0) {
		var err = _v0.a;
		var others = _v0.b;
		var errorPath = $elm$core$String$isEmpty(err.b4) ? 'Top-level object' : err.b4;
...
var $author$project$Validate$main = $elm$browser$Browser$element(
	{bZ: $author$project$Validate$init, cb: $author$project$Validate$subscriptions, cj: $author$project$Validate$update, ck: $author$project$Validate$view});
