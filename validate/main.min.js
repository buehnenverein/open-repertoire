// elm-watch hot {"version":"1.1.2","targetName":"validator","webSocketPort":61385}
"use strict";
(() => {
...
var $author$project$Validate$Init = {$: 'Init'};
var $author$project$Validate$init = function (_v0) {
	var inputs = {text: '', url: ''};
	return _Utils_Tuple2(
		{inputs: inputs, state: $author$project$Validate$Init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Validate$ReceiveValidationResult = F2(
	function (a, b) {
		return {$: 'ReceiveValidationResult', a: a, b: b};
	});
...
var $author$project$Helper$CustomValidations$Warning = {$: 'Warning'};
var $author$project$Helper$CustomValidations$warning = F2(
	function (path, msg) {
		return {kind: $author$project$Helper$CustomValidations$Warning, message: msg, messageForView: $elm$core$Maybe$Nothing, path: path};
	});
...
var $author$project$Helper$CustomValidations$forView = F2(
	function (viewMessage, msg) {
		return _Utils_update(
			msg,
			{
				messageForView: $elm$core$Maybe$Just(viewMessage)
			});
	});
var $author$project$Helper$CustomValidations$abstractDifferentFromDescription = F2(
	function (path, data) {
		...
		var _v0 = _Utils_Tuple2(data.description, data._abstract);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
...
var $author$project$Helper$CustomValidations$abstractOrDescription = F2(
	function (path, data) {
		...
		var combinedString = _Utils_ap(
			A2($elm$core$Maybe$withDefault, '', data._abstract),
			A2($elm$core$Maybe$withDefault, '', data.description));
...
var $author$project$Helper$CustomValidations$minMaxAge = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.suggestedMinAge, data.suggestedMaxAge);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var minAge = _v0.a.a;
			var maxAge = _v0.b.a;
...
var $author$project$Data$Root$LastShowEventType = {$: 'LastShowEventType'};
	...
	function (allEvents, path, data) {
		var isLast = function (ev) {
			return A2(
				$elm$core$List$all,
				function (other) {
					return _Utils_eq(other, ev) || (_Utils_cmp(other.startDate, ev.startDate) < 0);
				},
				allEvents);
		};
		var isDerniere = function (ev) {
			var _v0 = ev.eventType;
			if (_v0.$ === 'Just') {
				var types = _v0.a;
				return A2($elm$core$List$member, $author$project$Data$Root$LastShowEventType, types);
			} else {
				return false;
			}
		};
...
var $author$project$Helper$CustomValidations$previousStartDateDifferentFromCurrent = F2(
	function (path, data) {
		var _v0 = data.previousStartDate;
		if (_v0.$ === 'Just') {
			var previousStart = _v0.a;
			return _Utils_eq(data.startDate, previousStart) ? _List_fromArray(
				[
					A2(
					$author$project$Helper$CustomValidations$forView,
...
var $author$project$Helper$CustomValidations$previousStartNotRequired = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.eventStatus, data.previousStartDate);
		_v0$3:
		while (true) {
			if (_v0.a.$ === 'Just') {
				if (_v0.b.$ === 'Just') {
					switch (_v0.a.a.$) {
						case 'EventScheduledEvent':
							var _v1 = _v0.a.a;
							return _List_fromArray(
								[
									A2(
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$ExtendedLanguage = function (a) {
	return {$: 'ExtendedLanguage', a: a};
};
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$singletonParser = $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$pop(
	function (head) {
		...
		if (_v0.b && (!_v0.b.b)) {
			...
			return (!_Utils_eq(
				c,
				_Utils_chr('x'))) && $elm$core$Char$isAlphaNum(c);
		} else {
			return false;
		}
	});
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$extensionParser = A2(
	...
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$ExtendedLanguage,
	A2(
		$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$keep,
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Language = function (a) {
	return {$: 'Language', a: a};
};
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$languageParser = A2(
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$map,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Language,
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$PrivateUse = function (a) {
	return {$: 'PrivateUse', a: a};
};
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$privateUseParser = A2(
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$map,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$PrivateUse,
	A2(
		$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$keep,
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Region = function (a) {
	return {$: 'Region', a: a};
};
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$regionParser = A2(
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$map,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Region,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$oneOf(
		_List_fromArray(
			[
...
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Script = function (a) {
	return {$: 'Script', a: a};
};
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$scriptParser = A2(
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$map,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Script,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$xAlpha(4));
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Variant = function (a) {
	return {$: 'Variant', a: a};
};
var $dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$variantParser = A2(
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$map,
	$dillonkearns$elm_bcp47_language_tag$LanguageTag$Internal$Variant,
						...
						$dillonkearns$elm_bcp47_language_tag$LanguageTag$Parser$succeed(
							F6(
								function (language, script, region, variants, extensions, privateUse) {
									var options = {extensions: extensions, privateUse: privateUse, region: region, script: script, variants: variants};
...
var $author$project$Helper$CustomValidations$geocoordinates = F2(
	function (path, data) {
		var _v0 = _Utils_Tuple2(data.latitude, data.longitude);
		_v0$2:
		while (true) {
			if (_v0.a.$ === 'Nothing') {
				if (_v0.b.$ === 'Just') {
...
var $author$project$Helper$CustomValidations$minMaxPrice = F2(
	function (path, data) {
		var _v0 = data.maxPrice;
		if (_v0.$ === 'Just') {
			var max = _v0.a;
			return (_Utils_cmp(data.minPrice, max) > 0) ? _List_fromArray(
				[
					A2(
					$author$project$Helper$CustomValidations$forView,
...
var $author$project$Helper$CustomValidations$startAndEndDates = F2(
	function (path, data) {
		var startMillis = A2(
			...
			$rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(data.startDate));
		var endMillis = A2(
			$elm$core$Result$map,
			$elm$time$Time$posixToMillis,
			A2(
				...
				A2($elm$core$Result$fromMaybe, _List_Nil, data.endDate)));
...
var $author$project$Data$Root$PremiereEventType = {$: 'PremiereEventType'};
var $author$project$Helper$CustomValidations$validPremiere = F3(
	function (allEvents, path, data) {
		var isPremiere = function (ev) {
			...
			if (_v0.$ === 'Just') {
				var types = _v0.a;
				return A2($elm$core$List$member, $author$project$Data$Root$PremiereEventType, types);
			} else {
				return false;
			}
		};
...
var $author$project$Helper$CustomValidations$Error = {$: 'Error'};
var $author$project$Helper$CustomValidations$error = F2(
	function (path, msg) {
		return {kind: $author$project$Helper$CustomValidations$Error, message: msg, messageForView: $elm$core$Maybe$Nothing, path: path};
	});
	...
	function (name, path, data) {
		var getMessage = F3(
			function (idx, item, count) {
				return A2(
					...
					'must be unique. However, ID ' + (item.identifier + (' is also used in ' + ($elm$core$String$fromInt(count - 1) + (' other ' + (name + '.'))))));
			});
		var allIds = A2(
			$elm$core$List$map,
			function ($) {
		...
		return A2(
			...
			A2(
				...
				F2(
					function (idx, item) {
						var _v0 = A2($author$project$Helper$CustomValidations$elementCount, item.identifier, allIds);
						if (_v0 === 1) {
							return $elm$core$Maybe$Nothing;
						} else {
							var count = _v0;
...
var $author$project$Data$Root$Root = F4(
	function (atContext, organization, productions, version) {
		return {atContext: atContext, organization: organization, productions: productions, version: version};
	});
...
var $author$project$Data$Root$HttpsColonSlashSlashschemaDotorg = {$: 'HttpsColonSlashSlashschemaDotorg'};
var $author$project$Data$Root$parseAtContext = function (atContext) {
	if (atContext === 'https://schema.org') {
		return $elm$core$Result$Ok($author$project$Data$Root$HttpsColonSlashSlashschemaDotorg);
	} else {
...
var $author$project$Data$Root$Organization = F4(
	function (atType, address, logo, name) {
		return {address: address, atType: atType, logo: logo, name: name};
	});
...
var $author$project$Data$Root$OrganizationType = {$: 'OrganizationType'};
var $author$project$Data$Root$parseOrganizationAttype = function (organizationAttype) {
	if (organizationAttype === 'Organization') {
		return $elm$core$Result$Ok($author$project$Data$Root$OrganizationType);
	} else {
...
var $author$project$Data$Root$PostalAddress = F4(
	function (atType, addressLocality, postalCode, streetAddress) {
		return {addressLocality: addressLocality, atType: atType, postalCode: postalCode, streetAddress: streetAddress};
	});
var $author$project$Data$Root$PostalAddressType = {$: 'PostalAddressType'};
var $author$project$Data$Root$parsePostalAddressAttype = function (postalAddressAttype) {
	if (postalAddressAttype === 'PostalAddress') {
		return $elm$core$Result$Ok($author$project$Data$Root$PostalAddressType);
	} else {
															...
															return function (productionType) {
																return function (sponsor) {
																	return function (subtitle) {
																		return {_abstract: _abstract, accessModeSufficient: accessModeSufficient, accessibilityHazard: accessibilityHazard, accessibilitySummary: accessibilitySummary, additionalInfo: additionalInfo, atType: atType, audience: audience, creator: creator, description: description, events: events, funder: funder, genre: genre, identifier: identifier, inLanguage: inLanguage, name: name, productionType: productionType, sponsor: sponsor, subtitle: subtitle};
																	};
																};
															};
														};
...
var $author$project$Data$Root$AuditoryAccessModeSufficient = {$: 'AuditoryAccessModeSufficient'};
var $author$project$Data$Root$TactileAccessModeSufficient = {$: 'TactileAccessModeSufficient'};
var $author$project$Data$Root$TextualAccessModeSufficient = {$: 'TextualAccessModeSufficient'};
var $author$project$Data$Root$VisualAccessModeSufficient = {$: 'VisualAccessModeSufficient'};
var $author$project$Data$Root$parseAccessModeSufficientItem = function (accessModeSufficientItem) {
	switch (accessModeSufficientItem) {
		case 'auditory':
			return $elm$core$Result$Ok($author$project$Data$Root$AuditoryAccessModeSufficient);
		case 'tactile':
			return $elm$core$Result$Ok($author$project$Data$Root$TactileAccessModeSufficient);
		case 'textual':
			return $elm$core$Result$Ok($author$project$Data$Root$TextualAccessModeSufficient);
		case 'visual':
			return $elm$core$Result$Ok($author$project$Data$Root$VisualAccessModeSufficient);
		default:
...
var $author$project$Data$Root$FlashingHazardAccessibilityHazard = {$: 'FlashingHazardAccessibilityHazard'};
var $author$project$Data$Root$MotionSimulationHazardAccessibilityHazard = {$: 'MotionSimulationHazardAccessibilityHazard'};
var $author$project$Data$Root$NoFlashingHazardAccessibilityHazard = {$: 'NoFlashingHazardAccessibilityHazard'};
var $author$project$Data$Root$NoMotionSimulationHazardAccessibilityHazard = {$: 'NoMotionSimulationHazardAccessibilityHazard'};
var $author$project$Data$Root$NoSoundHazardAccessibilityHazard = {$: 'NoSoundHazardAccessibilityHazard'};
var $author$project$Data$Root$NoneAccessibilityHazard = {$: 'NoneAccessibilityHazard'};
var $author$project$Data$Root$SoundHazardAccessibilityHazard = {$: 'SoundHazardAccessibilityHazard'};
var $author$project$Data$Root$UnknownAccessibilityHazard = {$: 'UnknownAccessibilityHazard'};
var $author$project$Data$Root$UnknownFlashingHazardAccessibilityHazard = {$: 'UnknownFlashingHazardAccessibilityHazard'};
var $author$project$Data$Root$UnknownMotionSimulationHazardAccessibilityHazard = {$: 'UnknownMotionSimulationHazardAccessibilityHazard'};
var $author$project$Data$Root$UnknownSoundHazardAccessibilityHazard = {$: 'UnknownSoundHazardAccessibilityHazard'};
var $author$project$Data$Root$parseAccessibilityHazardItem = function (accessibilityHazardItem) {
	switch (accessibilityHazardItem) {
		case 'none':
			return $elm$core$Result$Ok($author$project$Data$Root$NoneAccessibilityHazard);
		case 'unknown':
			return $elm$core$Result$Ok($author$project$Data$Root$UnknownAccessibilityHazard);
		case 'flashingHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$FlashingHazardAccessibilityHazard);
		case 'motionSimulationHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$MotionSimulationHazardAccessibilityHazard);
		case 'soundHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$SoundHazardAccessibilityHazard);
		case 'noFlashingHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$NoFlashingHazardAccessibilityHazard);
		case 'noMotionSimulationHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$NoMotionSimulationHazardAccessibilityHazard);
		case 'noSoundHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$NoSoundHazardAccessibilityHazard);
		case 'unknownFlashingHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$UnknownFlashingHazardAccessibilityHazard);
		case 'unknownMotionSimulationHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$UnknownMotionSimulationHazardAccessibilityHazard);
		case 'unknownSoundHazard':
			return $elm$core$Result$Ok($author$project$Data$Root$UnknownSoundHazardAccessibilityHazard);
		default:
...
var $author$project$Data$Root$Audience = F4(
	function (atType, audienceType, suggestedMaxAge, suggestedMinAge) {
		return {atType: atType, audienceType: audienceType, suggestedMaxAge: suggestedMaxAge, suggestedMinAge: suggestedMinAge};
	});
var $author$project$Data$Root$PeopleAudienceType = {$: 'PeopleAudienceType'};
var $author$project$Data$Root$parseAudienceAttype = function (audienceAttype) {
	if (audienceAttype === 'PeopleAudience') {
		return $elm$core$Result$Ok($author$project$Data$Root$PeopleAudienceType);
	} else {
...
var $author$project$Data$Root$RoleType = {$: 'RoleType'};
var $author$project$Data$Root$parseCreatorRoleAttype = function (creatorRoleAttype) {
	if (creatorRoleAttype === 'Role') {
		return $elm$core$Result$Ok($author$project$Data$Root$RoleType);
	} else {
										...
										return function (previousStartDate) {
											return function (startDate) {
												return function (subtitleLanguage) {
													return function (url) {
														return {atType: atType, duration: duration, endDate: endDate, eventStatus: eventStatus, eventType: eventType, identifier: identifier, intermission: intermission, location: location, offers: offers, performer: performer, previousStartDate: previousStartDate, startDate: startDate, subtitleLanguage: subtitleLanguage, url: url};
													};
												};
											};
										};
...
var $author$project$Data$Root$EventType = {$: 'EventType'};
var $author$project$Data$Root$parseEventAttype = function (eventAttype) {
	if (eventAttype === 'Event') {
		return $elm$core$Result$Ok($author$project$Data$Root$EventType);
	} else {
...
var $author$project$Data$Root$eventAttypeDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Root$EventCancelledEvent = {$: 'EventCancelledEvent'};
var $author$project$Data$Root$EventMovedOnlineEvent = {$: 'EventMovedOnlineEvent'};
var $author$project$Data$Root$EventPostponedEvent = {$: 'EventPostponedEvent'};
var $author$project$Data$Root$EventRescheduledEvent = {$: 'EventRescheduledEvent'};
var $author$project$Data$Root$EventScheduledEvent = {$: 'EventScheduledEvent'};
var $author$project$Data$Root$parseEventEventStatus = function (eventEventStatus) {
	switch (eventEventStatus) {
		case 'EventScheduled':
			return $elm$core$Result$Ok($author$project$Data$Root$EventScheduledEvent);
		case 'EventCancelled':
			return $elm$core$Result$Ok($author$project$Data$Root$EventCancelledEvent);
		case 'EventMovedOnline':
			return $elm$core$Result$Ok($author$project$Data$Root$EventMovedOnlineEvent);
		case 'EventPostponed':
			return $elm$core$Result$Ok($author$project$Data$Root$EventPostponedEvent);
		case 'EventRescheduled':
			return $elm$core$Result$Ok($author$project$Data$Root$EventRescheduledEvent);
		default:
...
var $author$project$Data$Root$eventEventStatusDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Root$GuestPerformanceEventType = {$: 'GuestPerformanceEventType'};
var $author$project$Data$Root$PreviewEventType = {$: 'PreviewEventType'};
var $author$project$Data$Root$parseEventTypeItem = function (eventTypeItem) {
	switch (eventTypeItem) {
		case 'Premiere':
			return $elm$core$Result$Ok($author$project$Data$Root$PremiereEventType);
		case 'LastShow':
			return $elm$core$Result$Ok($author$project$Data$Root$LastShowEventType);
		case 'GuestPerformance':
			return $elm$core$Result$Ok($author$project$Data$Root$GuestPerformanceEventType);
		case 'Preview':
			return $elm$core$Result$Ok($author$project$Data$Root$PreviewEventType);
		default:
...
var $author$project$Data$Root$LocationItemPl = function (a) {
	return {$: 'LocationItemPl', a: a};
};
var $author$project$Data$Root$LocationItemVi = function (a) {
	return {$: 'LocationItemVi', a: a};
};
var $author$project$Data$Root$Place = F6(
	function (atType, address, latitude, longitude, name, wheelChairPlaces) {
		return {address: address, atType: atType, latitude: latitude, longitude: longitude, name: name, wheelChairPlaces: wheelChairPlaces};
	});
var $author$project$Data$Root$PlaceType = {$: 'PlaceType'};
var $author$project$Data$Root$parsePlaceAttype = function (placeAttype) {
	if (placeAttype === 'Place') {
		return $elm$core$Result$Ok($author$project$Data$Root$PlaceType);
	} else {
...
var $author$project$Data$Root$WheelChairPlace = F3(
	function (count, hasSpaceForAssistant, wheelchairUserCapacity) {
		return {count: count, hasSpaceForAssistant: hasSpaceForAssistant, wheelchairUserCapacity: wheelchairUserCapacity};
	});
...
var $author$project$Data$Root$VirtualLocation = F4(
	function (atType, description, name, url) {
		return {atType: atType, description: description, name: name, url: url};
	});
var $author$project$Data$Root$VirtualLocationType = {$: 'VirtualLocationType'};
var $author$project$Data$Root$parseVirtualLocationAttype = function (virtualLocationAttype) {
	if (virtualLocationAttype === 'VirtualLocation') {
		return $elm$core$Result$Ok($author$project$Data$Root$VirtualLocationType);
	} else {
...
var $author$project$Data$Root$Offer = F4(
	function (atType, name, priceSpecification, url) {
		return {atType: atType, name: name, priceSpecification: priceSpecification, url: url};
	});
var $author$project$Data$Root$OfferType = {$: 'OfferType'};
var $author$project$Data$Root$parseOfferAttype = function (offerAttype) {
	if (offerAttype === 'Offer') {
		return $elm$core$Result$Ok($author$project$Data$Root$OfferType);
	} else {
...
var $author$project$Data$Root$PriceSpecification = F4(
	function (atType, maxPrice, minPrice, priceCurrency) {
		return {atType: atType, maxPrice: maxPrice, minPrice: minPrice, priceCurrency: priceCurrency};
	});
var $author$project$Data$Root$PriceSpecificationType = {$: 'PriceSpecificationType'};
var $author$project$Data$Root$parsePriceSpecificationAttype = function (priceSpecificationAttype) {
	if (priceSpecificationAttype === 'PriceSpecification') {
		return $elm$core$Result$Ok($author$project$Data$Root$PriceSpecificationType);
	} else {
...
var $author$project$Data$Root$PerformanceRole = F3(
	function (atType, characterName, performer) {
		return {atType: atType, characterName: characterName, performer: performer};
	});
var $author$project$Data$Root$PerformanceRoleType = {$: 'PerformanceRoleType'};
var $author$project$Data$Root$parsePerformanceRoleAttype = function (performanceRoleAttype) {
	if (performanceRoleAttype === 'PerformanceRole') {
		return $elm$core$Result$Ok($author$project$Data$Root$PerformanceRoleType);
	} else {
...
var $author$project$Data$Root$CreativeWorkType = {$: 'CreativeWorkType'};
var $author$project$Data$Root$PlayType = {$: 'PlayType'};
var $author$project$Data$Root$parseProductionAttype = function (productionAttype) {
	switch (productionAttype) {
		case 'CreativeWork':
			return $elm$core$Result$Ok($author$project$Data$Root$CreativeWorkType);
		case 'Play':
			return $elm$core$Result$Ok($author$project$Data$Root$PlayType);
		default:
...
var $author$project$Data$Root$productionAttypeDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Root$AudiowalkProduction = {$: 'AudiowalkProduction'};
var $author$project$Data$Root$BallettProduction = {$: 'BallettProduction'};
var $author$project$Data$Root$DigitaltheaterProduction = {$: 'DigitaltheaterProduction'};
var $author$project$Data$Root$FigurentheaterProduction = {$: 'FigurentheaterProduction'};
var $author$project$Data$Root$GameTheaterProduction = {$: 'GameTheaterProduction'};
var $author$project$Data$Root$HoerspielProduction = {$: 'HoerspielProduction'};
var $author$project$Data$Root$ImprotheaterProduction = {$: 'ImprotheaterProduction'};
var $author$project$Data$Root$InstallationProduction = {$: 'InstallationProduction'};
var $author$project$Data$Root$KabarettComedyProduction = {$: 'KabarettComedyProduction'};
var $author$project$Data$Root$KammerkonzertProduction = {$: 'KammerkonzertProduction'};
var $author$project$Data$Root$KonzertProduction = {$: 'KonzertProduction'};
var $author$project$Data$Root$LecturePerformanceProduction = {$: 'LecturePerformanceProduction'};
var $author$project$Data$Root$LesungProduction = {$: 'LesungProduction'};
var $author$project$Data$Root$MusicalProduction = {$: 'MusicalProduction'};
var $author$project$Data$Root$MusiktheaterProduction = {$: 'MusiktheaterProduction'};
var $author$project$Data$Root$ObjekttheaterProduction = {$: 'ObjekttheaterProduction'};
var $author$project$Data$Root$OperProduction = {$: 'OperProduction'};
var $author$project$Data$Root$OperetteProduction = {$: 'OperetteProduction'};
var $author$project$Data$Root$PerformanceProduction = {$: 'PerformanceProduction'};
var $author$project$Data$Root$PhysicalTheatreProduction = {$: 'PhysicalTheatreProduction'};
var $author$project$Data$Root$PodcastProduction = {$: 'PodcastProduction'};
var $author$project$Data$Root$PuppentheaterProduction = {$: 'PuppentheaterProduction'};
var $author$project$Data$Root$SinfoniekonzertProduction = {$: 'SinfoniekonzertProduction'};
var $author$project$Data$Root$SprechtheaterProduction = {$: 'SprechtheaterProduction'};
var $author$project$Data$Root$SzenischeLesungProduction = {$: 'SzenischeLesungProduction'};
var $author$project$Data$Root$SzenischesKonzertProduction = {$: 'SzenischesKonzertProduction'};
var $author$project$Data$Root$TanzProduction = {$: 'TanzProduction'};
var $author$project$Data$Root$TheaterImOeffentlichenRaumProduction = {$: 'TheaterImOeffentlichenRaumProduction'};
var $author$project$Data$Root$WorkshopProduction = {$: 'WorkshopProduction'};
var $author$project$Data$Root$ZeitgenoessischerTanzProduction = {$: 'ZeitgenoessischerTanzProduction'};
var $author$project$Data$Root$parseProductionGenre = function (productionGenre) {
	switch (productionGenre) {
		case 'audiowalk':
			return $elm$core$Result$Ok($author$project$Data$Root$AudiowalkProduction);
		case 'ballett':
			return $elm$core$Result$Ok($author$project$Data$Root$BallettProduction);
		case 'digitaltheater':
			return $elm$core$Result$Ok($author$project$Data$Root$DigitaltheaterProduction);
		case 'figurentheater':
			return $elm$core$Result$Ok($author$project$Data$Root$FigurentheaterProduction);
		case 'game-theater':
			return $elm$core$Result$Ok($author$project$Data$Root$GameTheaterProduction);
		case 'hoerspiel':
			return $elm$core$Result$Ok($author$project$Data$Root$HoerspielProduction);
		case 'improtheater':
			return $elm$core$Result$Ok($author$project$Data$Root$ImprotheaterProduction);
		case 'installation':
			return $elm$core$Result$Ok($author$project$Data$Root$InstallationProduction);
		case 'kabarett-comedy':
			return $elm$core$Result$Ok($author$project$Data$Root$KabarettComedyProduction);
		case 'kammerkonzert':
			return $elm$core$Result$Ok($author$project$Data$Root$KammerkonzertProduction);
		case 'konzert':
			return $elm$core$Result$Ok($author$project$Data$Root$KonzertProduction);
		case 'lecture-performance':
			return $elm$core$Result$Ok($author$project$Data$Root$LecturePerformanceProduction);
		case 'lesung':
			return $elm$core$Result$Ok($author$project$Data$Root$LesungProduction);
		case 'musical':
			return $elm$core$Result$Ok($author$project$Data$Root$MusicalProduction);
		case 'musiktheater':
			return $elm$core$Result$Ok($author$project$Data$Root$MusiktheaterProduction);
		case 'objekttheater':
			return $elm$core$Result$Ok($author$project$Data$Root$ObjekttheaterProduction);
		case 'oper':
			return $elm$core$Result$Ok($author$project$Data$Root$OperProduction);
		case 'operette':
			return $elm$core$Result$Ok($author$project$Data$Root$OperetteProduction);
		case 'performance':
			return $elm$core$Result$Ok($author$project$Data$Root$PerformanceProduction);
		case 'physical-theatre':
			return $elm$core$Result$Ok($author$project$Data$Root$PhysicalTheatreProduction);
		case 'podcast':
			return $elm$core$Result$Ok($author$project$Data$Root$PodcastProduction);
		case 'puppentheater':
			return $elm$core$Result$Ok($author$project$Data$Root$PuppentheaterProduction);
		case 'sinfoniekonzert':
			return $elm$core$Result$Ok($author$project$Data$Root$SinfoniekonzertProduction);
		case 'sprechtheater':
			return $elm$core$Result$Ok($author$project$Data$Root$SprechtheaterProduction);
		case 'szenische-lesung':
			return $elm$core$Result$Ok($author$project$Data$Root$SzenischeLesungProduction);
		case 'szenisches-konzert':
			return $elm$core$Result$Ok($author$project$Data$Root$SzenischesKonzertProduction);
		case 'tanz':
			return $elm$core$Result$Ok($author$project$Data$Root$TanzProduction);
		case 'theater-im-oeffentlichen-raum':
			return $elm$core$Result$Ok($author$project$Data$Root$TheaterImOeffentlichenRaumProduction);
		case 'workshop':
			return $elm$core$Result$Ok($author$project$Data$Root$WorkshopProduction);
		case 'zeitgenoessischer-tanz':
			return $elm$core$Result$Ok($author$project$Data$Root$ZeitgenoessischerTanzProduction);
		default:
...
var $author$project$Data$Root$productionGenreDecoder = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Data$Root$FirstPerformanceProduction = {$: 'FirstPerformanceProduction'};
var $author$project$Data$Root$RevivalProduction = {$: 'RevivalProduction'};
var $author$project$Data$Root$WorldPremiereProduction = {$: 'WorldPremiereProduction'};
var $author$project$Data$Root$parseProductionProductionType = function (productionProductionType) {
	switch (productionProductionType) {
		case 'WorldPremiere':
			return $elm$core$Result$Ok($author$project$Data$Root$WorldPremiereProduction);
		case 'FirstPerformance':
			return $elm$core$Result$Ok($author$project$Data$Root$FirstPerformanceProduction);
		case 'Revival':
			return $elm$core$Result$Ok($author$project$Data$Root$RevivalProduction);
		default:
...
var $author$project$Data$Root$V2 = {$: 'V2'};
var $author$project$Data$Root$parseVersion = function (version) {
	if (version === 'v2') {
		return $elm$core$Result$Ok($author$project$Data$Root$V2);
	} else {
...
var $author$project$Validate$similarIssues = F2(
	function (issue1, issue2) {
		return A2($author$project$Validate$similarPath, issue1.path, issue2.path) && (_Utils_eq(issue1.message, issue2.message) && _Utils_eq(
...
var $author$project$Validate$Valid = {$: 'Valid'};
...
var $author$project$Validate$ErrorInfo = F3(
	function (keyword, additionalProperty, allowedEnumValues) {
		return {additionalProperty: additionalProperty, allowedEnumValues: allowedEnumValues, keyword: keyword};
	});
...
var $author$project$Validate$ValidationWarning = {$: 'ValidationWarning'};
...
var $author$project$Validate$toValidationIssue = function (message) {
	...
	if (_v0.$ === 'Warning') {
		return A3($author$project$Validate$ValidationIssue, message.path, message.message, $author$project$Validate$ValidationWarning);
	} else {
		var keyword = A2(
			$elm$core$Maybe$withDefault,
			'',
			$elm_community$list_extra$List$Extra$last(
				A2($elm$core$String$split, '/', message.path)));
		var errorInfo = {additionalProperty: $elm$core$Maybe$Nothing, allowedEnumValues: $elm$core$Maybe$Nothing, keyword: keyword};
		return A3(
			$author$project$Validate$ValidationIssue,
			message.path,
			message.message,
			...
			if (_v1.a.a.$ === 'Valid') {
				if (!_v1.b.b) {
					...
					return A2(
						...
						{
							errors: $author$project$Validate$groupIssues(custom),
							warnings: $author$project$Validate$groupIssues(customWarnings)
						},
						response);
				}
			} else {
				...
				return A2(
					$author$project$Validate$ResultError,
					{
						errors: $author$project$Validate$groupIssues(
			...
			case 'SubmitUrl':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: $author$project$Validate$Validating($elm$core$Maybe$Nothing)
						}),
					$elm$http$Http$get(
						{
							expect: A2($elm$http$Http$expectJson, $author$project$Validate$Response, $author$project$Validate$jsonDecoder),
							url: url
						}));
			case 'SubmitJson':
				var text = msg.a;
				...
				if (_v1.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Validate$Validating(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Validate$JsonParsingError(
									$elm$json$Json$Decode$errorToString(parsingError))
							}),
						$elm$core$Platform$Cmd$none);
				}
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Validate$RequestFailed(error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: A2($author$project$Validate$handleValidationResult, responseValue, validationResult)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Validate$SubmitUrl = function (a) {
	return {$: 'SubmitUrl', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(inputs.url),
					...
					_List_fromArray(
						[
							...
							$author$project$Validate$SubmitUrl(inputs.url)),
							$elm$html$Html$Attributes$disabled(
							(!buttonEnabled) || $elm$core$String$isEmpty(inputs.url)),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$value(inputs.text),
							$elm$html$Html$Attributes$class('u-full-width')
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Validate$SubmitJson(inputs.text)),
							$elm$html$Html$Attributes$disabled(
							(!buttonEnabled) || $elm$core$String$isEmpty(inputs.text)),
							$elm$html$Html$Attributes$class('button-primary u-pull-right')
						]),
					_List_fromArray(
						[
	...
	function (_v0, jsonValue) {
		...
		return A2(
			...
			A2(
				...
				'\n',
				A2($author$project$Validate$extractPath, err.path, jsonValue)));
	});
var $author$project$Validate$viewValidationIssue = F2(
	function (jsonValue, _v0) {
		var err = _v0.a;
		var others = _v0.b;
		var errorPath = $elm$core$String$isEmpty(err.path) ? 'Top-level object' : err.path;
...
var $author$project$Validate$main = $elm$browser$Browser$element(
	{init: $author$project$Validate$init, subscriptions: $author$project$Validate$subscriptions, update: $author$project$Validate$update, view: $author$project$Validate$view});
_Platform_export({'Validate':{'init':$author$project$Validate$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Validate.Msg","aliases":{},"unions":{"Validate.Msg":{"args":[],"tags":{"SubmitUrl":["String.String"],"SubmitJson":["String.String"],"UrlChange":["String.String"],"TextChange":["String.String"],"Response":["Result.Result Http.Error Json.Encode.Value"],"ReceiveValidationResult":["Json.Encode.Value","Json.Encode.Value"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));